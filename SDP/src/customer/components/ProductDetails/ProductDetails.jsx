    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-0">
          ...
          <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
            ...
            <div className="mt-4 lg:row-span-3 lg:mt-0">
              ...
              <p className="opacity-50 text-sm">5656 Ratings</p>
              <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">359 Reviews</p>
                </div>
              </div>

              <form className="mt-10">
                <Button onClick={handleAddToCart} variant="contained" sx={{px:"2rem",py:"1rem", bgcolor:"#9155fd",'&:hover':{backgroundColor: '##9155fd'}}}>
                   Add To Cart
                </Button>
              </form>
            </div>
            ...
            <Grid container spacing={7}>
              ...
              <Grid item xs={5}>
                 ...
                 <div className="flex items-center space-x-3">
                  ...
                  <p className="opacity-60 ">594809 Rating</p>
                 </div>
        ...
        <section className="pt-10">
            <h1 className="py-5 text-lg font-bold">Similer Products</h1>
